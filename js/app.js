(() => {
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("header-main__mobile-search")) document.querySelector(".header-main__search").classList.toggle("_active-search"); else if (!targetElement.closest(".header-main__search") && document.querySelector(".header-main__search._active-search")) document.querySelector(".header-main__search").classList.remove("_active-search");
        }
    };
    window["FLS"] = true;
    isWebp();
